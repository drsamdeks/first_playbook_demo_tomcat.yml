...
Vagrant.configure(VAGRANT_API_VERSION) do |config|
  ...
  config.vm.define "control" do |control|
    ...
    control.vm.provision "shell", args: [WEB1_IP], inline: <<-SCRIPT
      ...
      echo "db ansible_connection=ssh ansible_host=192.168.35.30 ansible_port=22 ansible_ssh_private_key_file=/home/vagrant/.ssh/ansible_key ansible_user=vagrant" >> /etc/ansible/hosts
    SCRIPT
  end
